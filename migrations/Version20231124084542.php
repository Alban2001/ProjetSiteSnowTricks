 ...
 */
final class Version20231124084542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD utilisateur_id INT DEFAULT NULL, DROP id_utilisateur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD id_utilisateur SMALLINT NOT NULL, DROP utilisateur_id');
    }
}
